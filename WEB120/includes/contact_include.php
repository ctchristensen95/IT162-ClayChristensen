...
//added my own website key's and server- clay christensen
$siteKey = "6LeH5NgZAAAAAK_XeECIKI555gj0oQ7iMozAVyYZ";
$secretKey = "6LeH5NgZAAAAABKqgJMV076GShw987fZSZi_S61y";
date_default_timezone_set('America/Los_Angeles'); #sets default date/timezone for this website
$server = 'aleapothecary.dreamhost.com';
//end config area ----------------------------------------
